...
public struct WorkspaceViewActions {
    ...
    public var saveOpenAIAPIKey: @MainActor (String) -> Void
    public var deleteOpenAIAPIKey: @MainActor () -> Void
    ...
    public init(
        ...
        saveOpenAIAPIKey: @escaping @MainActor (String) -> Void = { _ in },
        deleteOpenAIAPIKey: @escaping @MainActor () -> Void = {},
        ...
        self.saveOpenAIAPIKey = saveOpenAIAPIKey
        self.deleteOpenAIAPIKey = deleteOpenAIAPIKey
                ...
                ZStack {
                    ...
                    VStack(spacing: 0) {
                        ...
                        SettingsHubView(
                            ...
                            onSaveOpenAIAPIKey: actions.saveOpenAIAPIKey,
                            onDeleteOpenAIAPIKey: actions.deleteOpenAIAPIKey,
                            onOpenHealth: actions.openHealth,
                            onExportDiagnostics: actions.exportDiagnostics,
